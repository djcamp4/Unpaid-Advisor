    ...
    judge_raw = _call([
        {
            "role": "system",
            "content": (
                "You are a senior investment analyst making a clear, actionable recommendation. "
                "A value investor and a growth investor have both argued their views. "
                "Weigh their cases and deliver a decisive verdict using these exact definitions:\n\n"
                "BUY — the investment case is compelling; the stock is worth purchasing now.\n"
                "HOLD — genuine uncertainty exists, or there is a specific reason to wait "
                "(e.g. stretched valuation, pending catalyst, near-term risk). "
                "You must be able to name the specific reason — HOLD is not a safe default.\n"
                "DON'T BUY — fundamentals are weak, valuation is clearly stretched, or risks "
                "materially outweigh the upside.\n\n"
                "If both investors made positive cases with no major red flags, the verdict is BUY. "
                "Do not soften a positive analysis into HOLD out of caution. "
                + (
                    "The stock data shows a recent congressional purchase — a genuine bullish signal. "
                    "Lean toward BUY when the cases are close and add ~15 points to your confidence. "
                    if congress_context else ""
                ) +
                ...
                "Start directly with the most important observation. "
